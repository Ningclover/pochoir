...
pochoir plot-slice3d -a store/initial/drift3d.npz -o plots/drift3d/image_IVA_drift3D_sliceZ_coll.png -d z -i 170
...
pochoir plot-slice3d -a store/initial/weight3d.npz -o plots/weight3d/image_IVA_weight3D_sliceZ_coll.png -d z -i 170
...
pochoir plot-slice3d -a store/boundary/weight3d.npz -o plots/weight3d/image_IVA_weight3D_sliceZ_coll.png -d z -i 170
