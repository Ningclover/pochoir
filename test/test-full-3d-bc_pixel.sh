...
do_gen_drift () {
    local name=$1 ; shift
    local geom=$1; shift
    local gen="pcb_drift_pixel_with_grid_dense"
    local cfg="example_gen_pcb_drift_pixel_with_grid_dense.json"
...
do_gen_weight () {
    local name=$1 ; shift
    local geom=$1; shift
    local gen="pcb_pixel_with_grid_dense"
    local cfg="example_gen_pixel_with_grid_dense.json"
