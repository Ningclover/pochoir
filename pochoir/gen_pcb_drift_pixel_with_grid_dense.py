...
def mirror_xaxis(id_circ1,x0,y0,r):
    ...
    id_circ2=[]
    for id in id_circ1:
        id_circ2.append((id[0],y0-(id[1]-y0)-1))
    return id_circ2
...
def mirror_yaxis(id_circ1,x0,y0,r):
    ...
    id_circ2=[]
    for id in id_circ1:
        id_circ2.append((x0-(id[0]-x0)-1,id[1]))
    return id_circ2
...
def mirror_center(id_circ1,x0,y0):
    ...
    id_circ2=[]
    for id in id_circ1:
        id_circ2.append((x0-(id[0]-x0)-1,y0-(id[1]-y0)-1))
    return id_circ2
...
def draw_pcb_plane_dense(shape,arr,z,r1,val):
    draw_plane(arr,z,val)
    x=[5,shape[0]-5,5,shape[0]-5]
    y=[5,5,shape[0]-5,shape[0]-5]
    for i in range(4):
        xc,yc=x[i],y[i]
        id_circ3 = draw_quarter_circle(xc,yc,r1)
...
def generator(dom, cfg):
    ...
    #draw_pcb_plane((len(arr),len(arr[0])),arr,pp_loweredge+pcb_width,r1,-2000)
    draw_pcb_plane_dense((len(arr),len(arr[0])),arr,pp_loweredge+pcb_width,r1,-2000)
    barr[arr==0]=0
