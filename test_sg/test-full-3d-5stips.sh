...
do_domain weight2d 1050,2000   '0.1*mm'
do_domain weight3d 750,34,2000 '0.1*mm'
...
do_fdm weight2d 1      10000000      0.00000002   fix,fix

# special step to form iva/bva from 2D solution
want initial/weight3dfull \
     pochoir bc-interp --xcoord '37.5*mm' \
...
do_fdm weight3dfull 1     8000000      0.00000002     fix,per,fix
